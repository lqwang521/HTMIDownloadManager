#
# Be sure to run `pod lib lint HTMIDownloadManager.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/lqwang521/HTMIDownloadManager.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'HTMIDownloadManager/Classes/**/*'
  
  # s.resource_bundles = {
  #   'HTMIDownloadManager' => ['HTMIDownloadManager/Assets/*.png']
  # }
